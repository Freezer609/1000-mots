        ...
        subcategories: {
            'tous': {
                ...
                data: [
                    ...
                    ["tare", "au sens morale: infirmité mentale ou physique généralement congénitable", "nom"],
                    ["dépravé", "qui est corrompu moralement, qui se plaît dans le mal", "nom"],
                    ["irascible", "qui se met en colère pour tout et pour rien", "nom"],
                    ["ignare", "qui est ignorant, inculte", "nom"],
                    ["machiavélique", "par référence à l'oeuvre d'un célèbre écrivain italien de la Renaissance; qui n'hésite pas à tromper, à ruser pour parvenir à ses fins", "nom"],
                    ["ignoble", "sens propre: strictement opposé à ce qui est noble; sens moral: qualifie un acte d'une bassesse extrême inspirant le dégout ", "nom"],
                    ["imposteur(trice)", "qui se fait passer pour autre qu'il est en réalité ", "nom"],
                    ["opportuniste", "qui n'agit pas selon des principes, qui tire parti des circonstances pour servir son intérêt", "nom"],
                    ["sectaire", "qui a des opinions étroites, qui est intolérant à l'égard des autres", "nom"],
                    ["abject", "qui inspire la révolte et le mépris", "nom"],
                    ["répréhensible", "qui mérite d'être repris, d'être condamné par la morale", "nom"],
                    ["irrévérencieux", "qualifie une conduite ou des propos insolents, irrespectueux", "nom"],
                    ["impénitent", "qui ne regrette pas du tout sa conduite et n'est pas disposé à renoncer à sa façon de faire", "nom"],
                    ["compromission", "acte généralement répréhensible moralement, par lequel on expose sa réputation", "nom"],
                    ["vindicatif", "qui est porté à la vengeance", "nom"],
                    ["hâbleur", "qui se vante, qui exagère quand il raconte une histoire, qui promet plus qu'il ne peut tenir", "nom"],
                    ["veule", "qui n'a ni énergie, ni volonté, qui est lâche", "nom"],
                    ["pleutre", "qui n'a aucun courage physique, même face à des dangers minimes", "nom"],
                    ["partisan", "qui est inspiré par l'esprit de parti, qui n'a rien à voir avec l'intérêt général", "nom"],
                    ["ladre", "qui est d'une avarice sordide", "nom"],
                    ...
                    ["abuser", "tromper quelqu'un par de belles paroles. Autre sens de ce verbe, user avec excès, exagérer", "nom"],
                    ["avilissement", "déchéance morale et progressive", "nom"],
                    ["Chauvin(ne)", "qualifie un parti pris excesif pour ce qui concerne son pays et qyui conduire à la violence", "nom"],
                    ["cynisme", "philosophie antique qui professe le mépris des conventions sociales, de l'opinion publique et de la morale; sens courant: état d'esprit qui pousse à s'exprimer avec brutalité", "nom"],
                    ["léser", "causer préjudice, désavantager", "nom"],
                    ["lésiner", "chercher à faire le minimum de dépenses, essayant toujours de faire de petites économies", "nom"],
                    ["maléfique", "qui possède un pouvoir caché malfaisant", "nom"],
                    ...
                    ["partial", "qualifie un jugement injuste manifestant un parti pris", "nom"],
                    ...
                    ["pusillanisme", "qui manque d'audace, de courage; qui est craintif, faible: qui fuit les responsabilités", "nom"],
                        ...
                        subcategories: {
                            ...
                            'adjectifs': {
                                ...
                                data: [
                                    ...
                                    ["machiavélique", "par référence à l'oeuvre d'un célèbre écrivain italien de la Renaissance; qui n'hésite pas à tromper, à ruser pour parvenir à ses fins", "adjectif"],
                                    ["ignoble", "sens propre: strictement opposé à ce qui est noble; sens moral: qualifie un acte d'une bassesse extrême inspirant le dégout ", "adjectif"],
                                    ["opportuniste", "qui n'agit pas selon des principes, qui tire parti des cicronstances pour servir son ??", "adjectif"],
                                    ["sectaire", "qui a des opinions étroites, qui est intolérant à l'égard des autres", "adjectif"],
                                    ["abject", "qui inspire la révolte et le mépris", "adjectif"],
                                    ["répréhensible", "qui mérite d'être repris, d'être condamné par la morale", "adjectif"],
                                    ["irrévérencieux", "qualifie une conduite ou des propos insolents, irrespectueux", "adjectif"],
